...
The local integration tests separately verify exact owner signatures, immutable commands, transaction-byte checks, policy cleanup, final-event checks, and retry behavior. The live owner transaction and allocation journey now has separate evidence. See [six final owner actions](owner-actions-0e36ddc6-5cfa-46cf-8c2f-6e9ad0d5fdb8.json) and [the final Circle allocation](../arc/budget-allocation-9c60762d-cd1d-4fad-ace3-b45f971d9c6e.json). These records do not change the limits of the signature-only checks above.
